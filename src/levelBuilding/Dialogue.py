...
class Dialogue:
    ...
    def __init__(self, path_or_dict: str | dict[str, ...]):
    ...
    def _read_and_fill(self, path_or_dict: str | dict[str, ...]):
        if type(path_or_dict) is str:
            ...
            raise ValueError(f'The argument must be str or dict, not {type(path_or_dict)}')
