...
class TestLoadOneObject:
    ...
    def test_load_existing_file(self):
        ...
        result = load_one_object(
            '../assets/images/maze_tiles/player/player.png', PLAYER_SIZE, PLAYER_SIZE)
        assert result is not None
        assert isinstance(result, pygame.Surface)

    def test_load_nonexistent_file(self):
        """Проверка загрузки несуществующего файла"""
        result = load_one_object('fake.png', PLAYER_SIZE, PLAYER_SIZE)
...
class TestLoadAllObjects:
    ...
    def test_load_all_objects(self):
        result = load_all_objects('../assets/images/maze_tiles/level_0/walls',
